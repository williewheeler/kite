...
/**
 * <p>
 * <code>NamespaceHandler</code> allowing for declarative Kite configuration
 * using either XML or using annotations.
 * </p>
 * 
 * @version $Id: KiteNamespaceHandler.java 53 2010-03-17 05:51:10Z willie.wheeler $
...
public class KiteNamespaceHandler extends NamespaceHandlerSupport {
	...
	/**
	 * <p>
	 * Registers bean definition parsers for the various custom top-level Kite
	 * tags, such as <code>&lt;kite:circuit-breaker&gt;</code>.
	 * </p>
	 */
	public void init() {
